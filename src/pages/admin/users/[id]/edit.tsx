...
const EditUserPage: NextPage = () => {
  ...
  const handleCancel = () => {
    void router.push(`/admin/users/${typeof id === 'string' ? id : ''}`);
};
      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="flex items-center mb-4">
            <Link
              href={`/admin/users/${typeof id === 'string' || Array.isArray(id) ? id : ''}`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="py-4">
            <UserForm userId={id as string} onCancel={handleCancel} />
          </div>
        </div>
      </div>
    </AdminLayout>
